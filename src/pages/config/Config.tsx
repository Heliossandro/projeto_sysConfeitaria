            ...
            <div className="p-6 flex justify-center flex-col my-28 pb-[6rem]">
                <section className="flex items-center flex-col gap-9">
                    ...
                    <div className="flex flex-col gap-[2rem]">
                        ...
                        <a href="/add-item" className=" text-white bg-[#e29db7] text-2xl h-12 w-[150px] rounded-xl shadow-md hover:bg-[#db789e] duration-300 transform motion-safe:hover:scale-110 flex justify-center items-center">Produtos</a>
